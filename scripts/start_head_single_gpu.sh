#!/bin/bash
# Start all head node services with mutually exclusive GPU phases
# Training and game collection alternate, giving each full GPU access
#
# Key changes from start_all_head.sh:
# - Training and game collection are mutually exclusive (via Redis flag)
# - Each phase gets near-full GPU memory (0.85 fraction)
# - Eval runs on CPU only
#
# Usage: ./scripts/start_head_single_gpu.sh
...
echo "=============================================="
echo "  BGAI Distributed Training - Single GPU Mode"
echo "=============================================="
...
echo ""
echo "NOTE: Training and game collection are mutually exclusive."
echo "      Each phase gets exclusive GPU access for maximum utilization."
echo ""
...
# Both processes need memory allocated upfront, even though they alternate.
# Use 0.45 each so both fit. Actual computation is mutually exclusive.
# =============================================================================
export XLA_PYTHON_CLIENT_MEM_FRACTION=0.45
echo "JAX memory fraction: $XLA_PYTHON_CLIENT_MEM_FRACTION per process"
...
# =============================================================================
# Start Training Worker (full GPU access during training phases)
# =============================================================================
...
# =============================================================================
# Start GPU Game Worker (full GPU access during collection phases)
# =============================================================================
...
# =============================================================================
echo "[7/7] Starting evaluation worker (CPU only)..."
...
echo ""
echo "=============================================="
echo "  All services started (Single GPU Mode)!"
echo "=============================================="
echo ""
echo "PIDs:"
...
echo ""
echo "GPU Usage Mode: MUTUALLY EXCLUSIVE"
echo "  - Collection runs until enough games collected"
echo "  - Collection pauses, training runs on GPU"
echo "  - Training completes, collection resumes"
echo "  - Each phase should show ~80-95% GPU utilization"
echo ""
